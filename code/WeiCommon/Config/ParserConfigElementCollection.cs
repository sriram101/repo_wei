/*
**  File Name:		ParserConfigElementCollection.cs
**
**  Functional Description:
**
**      This class is used to read the configuration from app.config specifically Collection of <Parsers> in <Wei> tag 
**	
**
...
namespace Telavance.AdvantageSuite.Wei.WeiCommon
{
    ...
    public class ParserConfigElementCollection: ConfigurationElementCollection
    {
        public ParserConfigElementCollection()
        {
            base.AddElementName = "Parser";
        }
        public ParserConfigElement this[int index]
        {
            get
            {
                return base.BaseGet(index) as ParserConfigElement;
            }
            set
            {
