/*
**  File Name:		ProviderConfigElementCollection.cs
**
**  Functional Description:
**
**      This class is used to read the configuration from app.config specifically collection of <Provider> tags 
**	
**
...
{
    public class ProviderConfigElementColl: ConfigurationElementCollection
    {
        public ProviderConfigElementColl()
        {
