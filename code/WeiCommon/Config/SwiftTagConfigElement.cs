/*
**  File Name:		SwiftTagConfigElement.cs
**
**  Functional Description:
**
**      This class is used to read the configuration from app.config specifically <Tag> inside the swift tags 
**	
**
...
{
    public class SwiftTagConfigElement : ConfigurationElement
    {
