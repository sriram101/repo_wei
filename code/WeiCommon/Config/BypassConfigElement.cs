/*
**  File Name:		BypassConfigElement.cs
**
**  Functional Description:
**
**      This class is used to read the configuration from app.config specifically <url> in <bypass> tag 
**	
**
...
namespace Telavance.AdvantageSuite.Wei.WeiCommon
    {
    public class BypassConfigElement : ConfigurationElement
    {
