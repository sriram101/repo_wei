/*
**  File Name:		CredentialConfigElement.cs
**
**  Functional Description:
**
**      This class is used to read the configuration from app.config specifically <KeyValuePair> in <Credential> tag 
**	
**
...
{
    public class CredentialConfigElement: ConfigurationElement
    {
