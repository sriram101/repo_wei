/*
**  File Name:		IHandler.cs
**
**  Functional Description:
**
**      This is the interface that will be implemented by all the handlers like prime.
**	
**
...
namespace Telavance.AdvantageSuite.Wei.WeiService
{
    ...
    {
        String getMessageForTranslation(String message);
        String getRepackagedTranslatedString(Request request, String translateInput);
        String getRepackagedResponseString(String request, String response);
    }
}
