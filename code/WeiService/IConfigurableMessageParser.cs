/*
**  File Name:		IConfigurableMessageParser.cs
**
**  Functional Description:
**
**      This is the interface that will be implemented by all the parsers that can be configred from the app.config like xmlparser.
**	
**
...
{
    public interface IConfigurableMessageParser:IMessageParser
    {
        void configure(Translator translator, string param1, string param2, string param3, string param4, string param5);
    }
}
