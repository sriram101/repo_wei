/*
**  File Name:		AbortTranslationException.cs
**
**  Functional Description:
**
**      This Exception is used by the request manager to stop retrying translation
**	
**
...
{
    public class AbortTranslationException : Exception
    {
        public AbortTranslationException(string message)
            : base(message)
        {
