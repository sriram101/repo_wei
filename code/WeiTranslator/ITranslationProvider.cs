/*
**  File Name:		ITranslationProvider.cs
**
**  Functional Description:
**
**      This interface defines the external contract. All translation providers need to implement this interface
**	
**
...
namespace Telavance.AdvantageSuite.Wei.WeiTranslator
{
    ...
    {
        string translate(String message, string fromLanguage, string toLanguage);
        void initialize(string key, Int32 maxLength, WeiConfiguration config);
    }
}
