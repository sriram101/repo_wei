...
<asp:ScriptManager runat="server" ID="objScriptManager" EnablePartialRendering="true">
</asp:ScriptManager>
    ...
    <asp:UpdatePanel runat="server" UpdateMode="Always" ID="ParentPanel">
        ...
        <ContentTemplate>
            <asp:Panel ID= "grdPanel" CssClass = "Panel" runat="server">
                <asp:GridView ID="grdShowMessages" AutoGenerateColumns="False" GridLines="None" 
                    ...
                    onselectedindexchanged="grdShowMessages_SelectedIndexChanged" ShowHeaderWhenEmpty="true" >
        ...
        <%--<asp:UpdatePanel ID="pnlTranslationsLbl" runat="server" UpdateMode="Always">
            <ContentTemplate>
                <asp:Panel ID="Panel3" runat="server" CssClass="Panel">
                    <table width="100%">
                        <tr>
                            ...
                            <td align="right">
                                <asp:Button id="btnProcessReview" text="Release Message for OFAC Check" runat="server" OnClick="btnProcessReview_Click"/>
                            </td>
        ...
        <div class="modalPopup" runat="server" id="divPopup" style="display: none; padding:6px">

            <asp:Panel runat="Server" ID="panelDragHandle" CssClass="drag" ScrollBars="None">
                <%--Hold here to Drag this Box--%>
            </asp:Panel>

            <asp:UpdatePanel ID="upPopUp" runat="server" >
            <ContentTemplate>
                <asp:Panel ID="pnlSummary" runat="server" CssClass="Panel"  BackColor="white" Height="50px">
	                ...
	                <br />
                    <br />
                    <asp:TabContainer ID="tbContainer" runat="server" OnActiveTabChanged="tbContainer_TabChanged" 
                        ...
                        <asp:TabPanel ID="tbTranslations" runat="server" Height="400px">
                            <HeaderTemplate>Chinese Telegraphic Codes Translations</HeaderTemplate>
                                <ContentTemplate>
                                <asp:Panel ID="Panel6" runat="server"  ScrollBars="Auto" CssClass="PanelStyle" > <%--CssClass="Panel"--%>
                                    <asp:GridView ID="grdShowTranslations" AutoGenerateColumns="False" GridLines="None" 
                                    EmptyDataRowStyle-HorizontalAlign="Center" 
                                    EmptyDataRowStyle-Font-Bold="true" ShowFooter="true"
                                    EmptyDataRowStyle-BackColor="#d1dbe0" Width="100%" 
                                    CssClass="GridViewStyle" Visible="true" runat="server" 
                                    ...
                                    <RowStyle CssClass="RowStyle" /> 
                                        ...
                                        <asp:TemplateField HeaderText="Telegraphic Codes" HeaderStyle-HorizontalAlign="Left">
                                            <ItemTemplate >
                                                <asp:Label ID="lblCTCCodes" runat="server" Text='<%# Eval("CTCCode") %>' >
		                                        </asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Chinese Characters" HeaderStyle-HorizontalAlign="Left">
                                            <ItemTemplate >
                                                <asp:Label ID="lblChineseChar" runat="server" Text='<%# Eval("ChineseChar") %>' >
		                                        </asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Old Translation" HeaderStyle-HorizontalAlign="Left">
                                            <ItemTemplate >
                                                <asp:Label ID="lblOldTrans" runat="server" Text='<%# Eval("OldTrans") %>' >
		                                        </asp:Label>
                                            </ItemTemplate>
                                  
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="New Translation" HeaderStyle-HorizontalAlign="Left">
                                            <ItemTemplate >
                                                <asp:Label ID="lblNewTrans" runat="server" Text='<%# Eval("NewTrans") %>' >
		                                        </asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtNewTranslations" runat="server" Visible="true" Text='<%# Eval("NewTrans") %>'></asp:TextBox>
                                            </EditItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Reviewed By">
                                            <ItemTemplate>
                                                <asp:Label ID="lblReviewedBy" runat="server" Text='<%# Eval("ReviewOper") %>' >
		                                        </asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Approved By" Visible="false">
                                            <ItemTemplate>
                                                <asp:Label ID="lblApprovedBy" runat="server" Text='<%# Eval("ApprovedOper") %>' >
		                                        </asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField >
                        ...
                        <asp:TabPanel ID="tbAudit" runat="server">
                            <HeaderTemplate>Audit Details</HeaderTemplate>
                                <ContentTemplate>
                                    <asp:UpdatePanel runat="server" ID="ChildControl2" UpdateMode="Always">
                                        <ContentTemplate>
                                            <asp:Panel ID="pnlAudit" runat="server" ScrollBars="Auto" CssClass="PanelStyle"> <%--CssClass="Panel"--%>
                                            <asp:GridView ID="grdShowAudit" runat="server" AutoGenerateColumns="False" GridLines="None" Width="100%" 
                                            CssClass="GridViewStyle" Visible="true" >
                                                ...
                                                <asp:TemplateField HeaderText="Audit Message" HeaderStyle-HorizontalAlign="Left" >
                                                    ...
                                                    <ItemTemplate>
                                                       <%-- <%# Eval("Message").ToString().Replace("\r\n", "<br/>").Trim()%> --%>
                                                         <%# Eval("Message").ToString().Replace(";", "<br/>").Replace("\r", "<br/>").Trim()%>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                    </asp:GridView>
        ...
        <%--<asp:UpdatePanel runat="server" UpdateMode="Always" ID="UpdatePanel2">
            <ContentTemplate>
                <asp:Panel ID="pnlSummary" runat="server" CssClass="Panel"  BackColor="white" Height="50px">
                    ...
                    <asp:TabContainer ID="tbContainer" runat="server" OnActiveTabChanged="tbContainer_TabChanged" 
                        ActiveTabIndex="0" AutoPostBack="true">
                        <asp:TabPanel ID="tbTranslations" runat="server">
                            <HeaderTemplate>Chinese Telegraphic Codes Translations</HeaderTemplate>
                                <ContentTemplate>
                                    <asp:GridView ID="grdShowTranslations" AutoGenerateColumns="False" GridLines="None" 
                                    EmptyDataRowStyle-HorizontalAlign="Center" 
                        ...
                        <asp:TabPanel ID="tbOriginalMessage" runat="server">
                            ...
                            <ContentTemplate>
                                <asp:Panel ID="Panel4" runat="server" CssClass="Panel" ScrollBars="Vertical">
	                                <asp:GridView ID="grdShowDetails" runat="server" AutoGenerateColumns="False" GridLines="None"
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="Original Message">
                                                ...
                                                <asp:TemplateField HeaderText="Translated Message">
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                <ItemStyle HorizontalAlign="Left" />
                                                <ItemTemplate>
                        ...
                        <asp:TabPanel ID="tbAudit" runat="server">
                            <HeaderTemplate>Audit Details</HeaderTemplate>
                                <ContentTemplate>
                                    <asp:UpdatePanel runat="server" ID="ChildControl2" UpdateMode="Always">
                                        <ContentTemplate>
                                            <asp:Panel ID="pnlAudit" CssClass="Panel" runat="server">
                                            <asp:GridView ID="grdShowAudit" runat="server" AutoGenerateColumns="False" GridLines="None" Width="100%" 
                                            CssClass="GridViewStyle" Visible="true" ScrollBars="Vertical"
                                                >
