<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Messages.aspx.cs"  Inherits="Telavance.AdvantageSuite.Wei.WeiDashboard.Messages" %>
        ...
        <ContentTemplate>
            ...
            <asp:Panel ID="Panel2" runat="server" CssClass="Panel"  ScrollBars="Auto">
                <asp:GridView ID="grdShowMessages" AutoGenerateColumns="False" GridLines="None" 
                    ...
                    onselectedindexchanged="grdShowMessages_SelectedIndexChanged" >
                                ...
                                <Columns>
                                   ...
                                   <asp:BoundField HeaderText="ID" DataField="ID" SortExpression="ID" ItemStyle-Wrap="false" />
                                    ...
                                    <asp:BoundField HeaderText="Status" DataField="Status" SortExpression="Status"  ItemStyle-Wrap="false"/>
